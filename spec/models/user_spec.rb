...
describe User do
  ...
  it "should reject email addresses idential up to case" do
  ...
  describe "password encryption" do
    ...
    describe "has password? method" do
      ...
      it "should return true if the paswords match" do
  ...
  describe "micrpost associations" do
    ...
    it "should have a micrpost attribute" do
      @user.should respond_to(:micrposts)
    end
    
    it "should have the right microposts in teh right order" do
      @user.micrposts.should == [@mp2, @mp1]
    end
    
    it "should destroy associated micrposts" do
      @user.destroy
      [@mp1, @mp2].each do |micrpost|
        Micrpost.find_by_id(micrpost.id).should be_nil
      end
    end
  end
  ...
  describe "status feed" do
    ...
    it "should include teh micrposts of followed users" do
      followed = Factory(:user, :email => Factory.next(:email))
      mp3 = Factory(:micrpost, :user => followed)
  ...
  describe "relationships" do
    ...
    it "shoudl follow another user" do
      @user.follow!(@followed)
    ...
    it "should include teh follower in the followers array" do
      @user.follow!(@followed)
